...
#define FFMPEG_CONFIGURATION "--cc=/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin10-gcc-4.2.1 --as='gas-preprocessor.pl /Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin10-gcc-4.2.1' --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS3.0.sdk --enable-cross-compile --target-os=darwin --arch=arm --cpu=cortex-a8 --enable-gpl --enable-pic --enable-postproc --enable-swscale --enable-avfilter --enable-avfilter-lavf"
